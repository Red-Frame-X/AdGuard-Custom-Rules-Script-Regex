...
def main(argv: list[str] | None = None) -> int:
    ...
    header = [
        ...
        f"! Source: {args.input}",
        "! Usage: Subscribe to this file's raw URL from uBO Lite > Options > Filter lists > Add filter list.",
        "! Compatibility: Remote filter-list subscriptions require uBO Lite 2026.621.1813 or newer and are unavailable on Safari.",
        "",
    ]
