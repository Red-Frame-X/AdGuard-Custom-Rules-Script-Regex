...
AdGuard Browser Extension MV3の新しいバージョンでは、カスタムフィルタを拡張機能本体とは独立して更新できます。ただし、通信状況、配布元の応答、AdGuard側の更新周期により反映まで時間がかかる場合があります。更新されない場合は、カスタムフィルタの更新を手動で実行してください。
